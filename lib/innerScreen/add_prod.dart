...
class UploadProductForm extends StatefulWidget {
  static const route = '/UploadProductForm';
...
class _UploadProductFormState extends State<UploadProductForm> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      key: context.read<AmenuController>().getAddProductscaffoldKey,
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  Header(
                    fct: () {
                      context.read<AmenuController>().controlAddProductsMenu();
                    },
                    headTittle: 'add product',
                  ),
                  Container(
